...
main() {
    ...
    let t2: TypeInfo = TypeInfo.get("cangjiedemo.Foo")
    let t3: TypeInfo = TypeInfo.get("std.net.TcpSocket")
    let t4: TypeInfo = TypeInfo.get("stdx.net.http.ServerBuilder")
    println(t1)
    println(t2)
    println(t3)
    println(t4)
...
main(){
    ...
    println("obj 的实例成员属性包含${instanceProps}")
...
main(): Unit {
    ...
    num = (funcInfo.apply(TypeInfo.of<Foo>(), [1, 2]) as Int64).getOrThrow()
    println(num)
}
```
