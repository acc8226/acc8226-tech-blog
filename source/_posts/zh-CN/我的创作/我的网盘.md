...
* [Alist 网盘](https://github.com/Xhofe/alist/releases) 一个支持多种存储的文件列表程序
* [Cloudreve 网盘](https://github.com/cloudreve/Cloudreve/releases) 支持多家云存储驱动的公有云文件系统
* [Vaultwarden](https://github.com/dani-garcia/vaultwarden) Bitwarden 客户端 API 的替代服务器实现
