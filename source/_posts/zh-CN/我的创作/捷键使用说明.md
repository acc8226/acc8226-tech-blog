...
<img src="https://img.shields.io/badge/测试版-24.6--beta1-yellow" style="display:inline-block;margin: 0 1px;" alt="Static Badge">
</div>
...
CapsLock + 单按键 将激活某些功能，其中大部分按键习惯参考自 [MyKeymap][]，小部分我参考了苹果 macOS 系统。
...
格式为 `dl软件名称`。例如输入 `dlvscode` 表示转到 VSCode 下载站
