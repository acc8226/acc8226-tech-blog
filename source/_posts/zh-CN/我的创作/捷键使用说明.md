...
![软件截图](https://www.kunduo.com/u/upload/202407/1720686143392778.png)
...
CapsLock + 单按键 能激活某些预设功能，其中部分键位参考了 [MyKeymap][]，并从苹果 macOS 系统快捷键得到启发。例如 CapsLock + f 单手操作即可轻松实现窗口最大化。
