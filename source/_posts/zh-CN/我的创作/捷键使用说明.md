...
捷键是一款免费 Windows 键鼠增强工具，本人基于 [Autohotkey2](https://www.autohotkey.com/) 开发。其目的为简化 Windows 键鼠操作而生。它拥有强大按键映射以及快捷键增强功能，既可作为传统启动器，又增强了鼠标侧边按键功能，同时支持热字符。为获得最佳体验，强烈建议搭配带侧键鼠标和全局鼠标手势软件，并启用开机自启。
...
* `wangluolianjie|网络连接` 打开 网络连接
* `shoucangjia|收藏夹` 打开 收藏夹
* `ziti|font|字体` 字体 打开字体文件夹
* 打印机
* 我的文档
* 回收站
* 我的桌面
...
* xaa 意为 account 网名：张三
* xdd 意为 address 收货地址：湖南省 永州市 祁阳县 人民东路 1 号
* xmm 意为 mobile 手机号：13588888888
* xee 意为 email 邮箱：88888888@qq.com
* xqq 意为 QQ 号码：88888888
