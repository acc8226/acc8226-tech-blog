...
<a href="https://jiejian.sourceforge.io/jiejian-beta.7z" style="border-bottom:none;" title="更新时间 2025-02-09">
  <img src="https://img.shields.io/badge/beta-25.2--beta2-yellow" style="display:inline-block;margin: 0 1px;" alt="Static Badge">
</a>
</div>
...
<!-- Begin SF Tag -->
<div class="sf-root" data-id="3768489" data-badge="oss-users-love-us-white" style="width:125px">
    <a href="https://sourceforge.net/projects/jiejian/" target="_blank">jiejian（捷键）for windows</a>
</div>
<script>(function () {var sc=document.createElement('script');sc.async=true;sc.src='https://b.sf-syn.com/badge_js?sf_id=3768489';var p=document.getElementsByTagName('script')[0];p.parentNode.insertBefore(sc, p);})();
</script>
<!-- End SF Tag -->
...
1. 音乐类软件囊括了 Spotify、QQ 音乐、网易云、洛雪音乐助手。其中 Ctrl + F3 打开文件对本地音乐播放器适配良好，在线音乐类软件可能不适用。
...
* .nn 取自 now 的首字母 n，插入当前日期时间，举例 `2023-08-27 09:10:41`
* .dd 取自 date 的首字母 d，插入特定格式的当前日期时间，举例 `Date: 2023-12-22 21:23:30`
* .ff 取自 分割线 的首字母 f，在当前光标处插入一行分割线，举例 `——————— ฅ՞• •՞ฅ ———————`
...
* .aa 意为 我的用户名(account)，奔跑的企鹅
* .dd 意为 我的收货地址(addr)，北京市 大兴区 清漪园小区 8栋2楼201室
* .ee 意为 我的邮箱(email)，8888888@qq.com
* .mm 意为 我的手机号1(mobile)，13555555555
* .mo 意为 我的手机号2(mobile)，13888888888
* .na 意为 我的姓名(name)，至尊宝
* .qq 意为 我的QQ，10000
