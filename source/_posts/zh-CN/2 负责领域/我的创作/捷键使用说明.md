...
本文最初发布在 https://feipig.fun/jiejian
...
软件大小 1.6 MB | 多国语言支持 | 最低 32 位和 64 位 Windows XP 系统支持，Win 7 以上系统使用更佳
...
其中第 22 项的浏览器，我在 windows 平台选择的是 chrome 系列浏览器，比如国产猫眼浏览器、360 极速浏览器、百分浏览器。
