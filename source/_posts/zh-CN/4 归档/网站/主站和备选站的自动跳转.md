...
需求：如果 [feipig.fun](https://feipig.fun) 可访问则访问 [feipig.fun](https://feipig.fun)，否则访问[博客园对应地址](https://www.cnblogs.com/elaa/p/17994004)。
...
<body>
    ...
    <script>
        ...
        window.onload = function() {
            var url1 = 'https://feipig.fun/zh-cn/4c2b72aaa7d0'// 时好时坏 
