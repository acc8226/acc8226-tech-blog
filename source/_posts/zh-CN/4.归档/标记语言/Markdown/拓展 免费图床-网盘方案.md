...
用法：新建存储桶，需要把存储桶的访问权限设置为公有读私有写。<!-- more -->
...
举例上传一图片，原始地址为 `https://gitee.com/acc8226/html-nav/blob/master/snipaste.png`,则将 blob 改为 raw 则是图片的原始地址了：`https://gitee.com/acc8226/html-nav/raw/master/snipaste.png`
...
PicGo - 免费开源的图片上传与管理工具 (Markdown 写作贴图 / 跨平台图床应用)
