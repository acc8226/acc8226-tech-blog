...
一般推荐使用 [tuna 源](https://mirrors.tuna.tsinghua.edu.cn/python/)下载使用安装版，可选配 pip 和一些常用类库。
...
首先下载 Anaconda [清华源](https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/)

[Anaconda3-2023.09-0-Windows-x86_64.exe](https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Anaconda3-2023.09-0-Windows-x86_64.exe)
...
* 下载 — [Python 3.14.5 离线文档](https://docs.python.org/zh-cn/3/download.html)
