...
phone = '13566789900'
print(re.match(r'1\d{10}$', phone))     # 匹配成功
```
...
# 打印时间戳，从 1970年1月1日（UTC/GMT的午夜）开始所经过的秒数
print(time.time())
# 打印当地时间
...
while True:
    print(conn.recv(100).decode('utf-8'))
...
while True:
    sk.send(input('请输入聊天内容').encode('utf-8'))
    print(sk.recv(100).decode('utf-8'))
```
