---
title: Vue2 模板语法
date: 2026-06-23 21:54:12
updated: 2026-06-23 21:54:12
categories:
  - 框架
  - js
tags:
...
Mustache 标签将会被替代为对应数据对象上 `msg` property 的值。无论何时，绑定的数据对象上 `msg` property 发生了改变，插值处的内容都会更新。<!-- more -->
...
## [缩写](https://v2.cn.vuejs.org/v2/guide/syntax.html#缩写)
