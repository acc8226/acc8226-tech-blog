---
title: Vue2 实例
date: 2026-06-23 21:36:58
updated: 2026-06-23 21:36:58
categories:
  - 框架
  - js
tags:
...
虽然没有完全遵循 [MVVM 模型](https://zh.wikipedia.org/wiki/MVVM)，但是 Vue 的设计也受到了它的启发。因此在文档中经常会使用 `vm` (ViewModel 的缩写) 这个变量名表示 Vue 实例。<!-- more -->

当创建一个 Vue 实例时，你可以传入一个**选项对象**。这篇教程主要描述的就是如何使用这些选项来创建你想要的行为。作为参考，你也可以在 [API 文档](https://v2.cn.vuejs.org/v2/api/#选项-数据)中浏览完整的选项列表。

## [数据与方法](https://v2.cn.vuejs.org/v2/guide/instance.html#数据与方法)
...
## [实例生命周期钩子](https://v2.cn.vuejs.org/v2/guide/instance.html#实例生命周期钩子)
