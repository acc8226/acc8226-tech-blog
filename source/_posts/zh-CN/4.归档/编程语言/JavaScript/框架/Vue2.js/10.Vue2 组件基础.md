---
title: Vue2 组件基础
date: 2026-06-25 21:44:21
updated: 2026-06-25 21:44:21
categories:
  - 框架
  - js
tags:
...
如果 Vue 没有这条规则，点击一个按钮会影响到*其它所有实例*：

## [组件的组织](https://v2.cn.vuejs.org/v2/guide/components.html#组件的组织)
...
## [通过 Prop 向子组件传递数据](https://v2.cn.vuejs.org/v2/guide/components.html#通过-Prop-向子组件传递数据)
...
## [单个根元素](https://v2.cn.vuejs.org/v2/guide/components.html#单个根元素)
...
## [监听子组件事件](https://v2.cn.vuejs.org/v2/guide/components.html#监听子组件事件)
...
### [使用事件抛出一个值](https://v2.cn.vuejs.org/v2/guide/components.html#使用事件抛出一个值)
...
- [``](https://v2.cn.vuejs.org/v2/guide/components-edge-cases.html#X-Templates)
