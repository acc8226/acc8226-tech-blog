...
你可以使用淘宝定制的 cnpm (gzip 压缩支持) 命令行工具代替默认的 npm:`npm install -g cnpm --registry=https://registry.npmmirror.com`
...
1. win + r 打开运行，输入%appdata%
1. 删除 npm 和 npmcache 文件夹
1. 执行 npm cache clean --force 命令
1. 卸载 Node.js
1. 重新安装 Node.js
...
[NPM 使用介绍](https://www.runoob.com/nodejs/nodejs-npm.html) | 菜鸟教程
