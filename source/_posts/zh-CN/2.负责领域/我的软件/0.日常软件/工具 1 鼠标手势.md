...
| ----  | ---- | ---- | ---- | ---- | ---- |
| 1 | ↗︎ |【常用】 max/最大化 | Win + ↑ | - | meta + pageUp |
| 2 | ↙︎ |【常用】min/最小化 | 最小化 | ⌘m | meta + pageDown |
...
| 7 | ← |【常用】prev/后退 | Alt + ← 【捷键 增强】| ⌘[ | Alt + ← |
| 8 | → |【常用】next/前进 | Alt + → 【捷键 增强】| ⌘] | Alt + → |
| 9 | ↩ | reopen/重新打开 | Ctrl + Shift + t | ⌘⇧t | Ctrl + Shift + t |
...
| 23 | →←→ | 哔哩哔哩 1 倍速 | Shift + 1 | - | Shift + 1 |
| 24 | ←→← | 哔哩哔哩 2 倍速 | Shift + 2 | - | Shift + 2 |
...
【win】[FastGestures](https://fg.zhaokeli.com) 鼠标/触控板/屏手势
