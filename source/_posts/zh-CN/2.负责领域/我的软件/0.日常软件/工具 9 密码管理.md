...
* [官方支持 Windows](https://keepass.info/download.html)
* [安卓版推荐下载](http://www.keepassdx.com)
* [mac 版推荐下载](https://apps.apple.com/cn/app/strongbox/id1270075435?mt=12)
...
备用 [Google Authenticator APK for Android - Download](https://google-authenticator.en.softonic.com/android)

not Authy 据说口碑很高。但是这个 app 要安装手机只提供应用商店的入口且国区不能注册手机号，差评。
...
* [BitWarden](https://sspai.com/post/54728)：妈妈再也不用担心我记不住密码啦 - 少数派
* [使用双重身份验证 (2FA) 保护您的帐户](https://docs.github.com/cn/authentication/securing-your-account-with-two-factor-authentication-2fa) - GitHub Docs
