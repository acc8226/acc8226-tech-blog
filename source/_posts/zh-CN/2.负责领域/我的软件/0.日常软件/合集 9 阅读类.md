...
【win】[Sumatra PDF] is a PDF, ePub, MOBI, CHM, XPS, DjVu, CBZ, CBR reader for Windows. 且提供安装版和绿色版，小巧好用<!-- more -->
...
windows 使用 wps 即可。
linux 国产系统一般自带，或者使用 [葫芦OFD](https://www.oneofd.cn/index.html)，有软件版和 web 版。
否则 wps 云文档也能临时应付。
