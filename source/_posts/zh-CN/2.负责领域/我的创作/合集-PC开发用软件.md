...
* 【mac】[Sequel Pro](https://sequelpro.com) for mysql
* 【win】[sqlite-gui](https://github.com/little-brother/sqlite-gui) Lightweight SQLite editor for Windows
...
* ——————— ฅ՞• •՞ฅ ———————
* 【已过时】[JetBrains Fleet](https://www.jetbrains.com/zh-cn/fleet)
...
**GUI**
VSCode 和 IDEA 会自带 Git 支持插件。特别的如果是 windows 系统推荐搭配【win 精品软件 安装版】[TortoiseGit](https://tortoisegit.org/download) | [镜像](https://mirrors.huaweicloud.com/tortoisegit/) 简称小乌龟。
...
not 【便携版】SVN 命令行工具 [Apache-Subversion-1.14.3](https://www.visualsvn.com/files/Apache-Subversion-1.14.3.zip)
