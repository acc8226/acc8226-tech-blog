...
| 左 上 右 | <span style="color: red;">S</span> 方向左 | <span style="color: red;">E</span> 方向上 | <span style="color: red;">F</span> 方向右 |
| 下 Home End | <span style="color: red;">D</span>own 方向下| <span style="color: red;">A</span> -> Home 键 |  <span style="color: red;">G</span> -> End 键 |
| . 删除 向下翻页 | C | <span style="color: red;">N</span> 表示 Delete 删除键| <span style="color: red;">空格</span> 表示 PgDown 向下翻页 |
| ; : | J | I | |
| \` @ | K | Y | |
