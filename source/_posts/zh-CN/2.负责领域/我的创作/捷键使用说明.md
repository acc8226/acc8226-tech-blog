...
核心设计理念是“以最小的操作成本完成最频繁的任务”，适用于程序员、设计师、文字工作者、系统管理员以及任何希望提升日常电脑使用效率的人群。为了获得最佳体验，建议用户：
...
本项目目前毫无保留发布在 [Gitee](https://gitee.com/acc8226/jiejian) | [Github](https://github.com/acc8226/jiejian)。欢迎各位在 [Github](https://github.com/acc8226) 上关注我。
...
在简化日常操作中，本人都希望免费、开源的“捷键”能为用户提供良好的实用价值。让每一次点击与敲击都变得更加精准、高效而富有意义。
