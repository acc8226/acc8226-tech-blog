...
2. 程序不方便调试。在程序调试时，如果通过日志输出day值，那么只能看到 0~4 之间的数值。
...
5. 枚举类型都实现了Java API中的 Comparable 接口，都可以通过方法compareTo与其他枚举值进行比较。比较其实就是比较 ordinal 的大小；
...
所有枚举类都继承**java.lang.Enum**类，Enum中定义了一些枚举中常用的方法：
